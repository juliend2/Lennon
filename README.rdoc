...
2-Then issue a "rake db:migrate", followed by a "rake db:seed".
3-Then log into the database you're using, do a "select * from options" and see what is the value assigned for admin_pass. This is your password. The username by default is admin. You'll need it to access to the admin once you're set up.
